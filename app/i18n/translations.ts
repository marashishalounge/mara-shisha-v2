...
export const translations = {
  es: {
    ...
    hero: {
      ...
      descripcion:
        "Vive una experiencia Ãºnica entre aromas, sabores y el mejor ambiente.",
      botonMenu: "Ver menÃº",
    ...
    menu: {
      ...
      subtitulo:
        "Descubre nuestra selecciÃ³n de shishas, copas, cervezas, bebidas y ofertas especiales.",
      ...
      items: {
        shishas: {
          title: "Shishas",
          description:
            "Sabores clÃ¡sicos, premium y especiales preparados al momento.",
          link: "Ver Shishas",
        },
        ...
        copas: {
          title: "Copas",
          description:
            "Ginebras, rones y whiskys seleccionados para acompaÃ±ar cada experiencia.",
          link: "Ver Copas",
        },
        ...
        bebidas: {
          title: "Bebidas",
          description:
            "Refrescos, zumos, energÃ©ticas y bebidas calientes.",
          link: "Ver Bebidas",
        },
    ...
    shishas: {
      ...
      descripcion:
        "Una experiencia creada para disfrutar aromas, sabores y momentos Ãºnicos.",

      normal: "Shisha Normal",
      normalPreparacion: "PreparaciÃ³n clÃ¡sica",
      normalBase: "Base tradicional",
      normalCarbon: "CarbÃ³n preparado al momento",
      normalSabores:
        "Elige tus sabores favoritos en nuestra secciÃ³n Sabores",
      ...
      premiumCarbon: "CarbÃ³n premium",
      premiumTabaco: "Tabaco negro seleccionado",
      premiumPreparacion: "PreparaciÃ³n exclusiva",
      ...
      premiumDescripcion:
        "Una preparaciÃ³n exclusiva para amantes de sabores intensos, frescura extrema y combinaciones Ãºnicas.",
    ...
    flavors: {
      titulo: "SABORES",
      subtitulo: "Elige tus sabores favoritos",
      chicle: "Chicle",
    ...
    drinks: {
      titulo: "COPAS",
      subtitulo: "Nuestra selecciÃ³n de bebidas",
      energia: "+1 â‚¬ con bebida energÃ©tica",

      ginebras: "Ginebras",
      rones: "Rones",
      whisky: "Whisky",

      categoriaAnterior: "CategorÃ­a anterior",
      siguienteCategoria: "Siguiente categorÃ­a",
      irCategoria: "Ir a categorÃ­a",
    },

    beverages: {
      titulo: "BEBIDAS",
      subtitulo:
        "Refrescos, bebidas frÃ­as y una selecciÃ³n de tÃ©s para acompaÃ±ar tu experiencia.",

      frias: "Bebidas frÃ­as",
      ...
      agua: "Agua",
      energeticas: "Bebidas energÃ©ticas",
    ...
    beers: {
      titulo: "CERVEZAS",
      subtitulo: "Disfruta de nuestras cervezas",
    },

    snacks: {
      titulo: "SNACKS",
      subtitulo: "Algo para picar",
    },

    offers: {
      titulo: "OFERTAS",
      subtitulo: "Promociones especiales de Mara",
    },
    ...
    about: {
      titulo: "SOBRE MARA",
      descripcion:
        "Un espacio pensado para disfrutar, relajarse y compartir buenos momentos.",
    },

    contact: {
      titulo: "CONTACTO",
      subtitulo: "Estamos aquÃ­ para ti",
      horario: "Horario",
    ...
    roulette: {
      titulo: "RULETA MARA",
      subtitulo: "Gira y descubre tu premio",
      boton: "GIRAR RULETA",
      girando: "GIRANDO...",
      premio: "TU PREMIO",
      enhorabuena: "Â¡ENHORABUENA!",
      ganado: "Â¡HAS GANADO!",
      chupito: "CHUPITO",
      cuboEstrellaGalicia: "CUBO DE ESTRELLA GALICIA",
      copa: "COPA",
      shishaClasica: "SHISHA CLÃSICA",
  ...
  en: {
    ...
    flavors: {
      titulo: "FLAVOURS",
      subtitulo: "Choose your favourite flavours",
      chicle: "Bubble gum",
    ...
    beers: {
      titulo: "BEERS",
      subtitulo: "Enjoy our selection of beers",
    },

    snacks: {
      titulo: "SNACKS",
      subtitulo: "Something to snack on",
    },

    offers: {
      titulo: "OFFERS",
      subtitulo: "Special Mara promotions",
    },

    events: {
      titulo: "EVENTS",
      subtitulo: "Experience Mara in a different way",
      proximamente: "Coming soon",
    },

    gallery: {
      titulo: "GALLERY",
      subtitulo: "Discover the Mara atmosphere",
    },

    about: {
      titulo: "ABOUT MARA",
      descripcion:
        "A space designed to relax, enjoy and share great moments.",
    },

    contact: {
      titulo: "CONTACT",
      subtitulo: "We are here for you",
    ...
    roulette: {
      titulo: "MARA ROULETTE",
      subtitulo: "Spin and discover your prize",
      boton: "SPIN THE WHEEL",
      girando: "SPINNING...",
      premio: "YOUR PRIZE",
